...
public class MzEnchantTable extends HorizontalBlock {
    protected MzEnchantTable() {
    ...
    public INamedContainerProvider getContainer(BlockState blockState, World world, BlockPos pos) {
        ...
        INamedContainerProvider containerProvider = new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new StringTextComponent("mz.enchant table");
            }

            @Override
            public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity) {
                return new MzEnchantTableContainer(i, world, pos, playerInventory, playerEntity);
            }
        };
