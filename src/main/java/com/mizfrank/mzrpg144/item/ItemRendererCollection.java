...
public class ItemRendererCollection {
    ...
    public static final RegistryObject<EntityType<MzArrowEntity>> MZ_ARROW_ENTITY = ENTITY_TYPES.register("mz_arrow",
            () -> EntityType.Builder.<MzArrowEntity>create(MzArrowEntity::new, EntityClassification.MISC)
